    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
      <div class="space-y-8">
        ...
        <div class="space-y-4">
          ...
          <h1
            class="text-4xl sm:text-5xl font-bold text-slate-900 leading-tight"
          >
        ...
        <!-- Contenu -->
        <div
          class="prose prose-slate max-w-none p-8 rounded-2xl bg-white border border-slate-200 shadow-xl"
        >
          <section class="mb-8">
          ...
          <section class="mb-8">
            ...
            <ul class="text-slate-700 list-disc pl-6 space-y-2">
              <li>Nom et prénom</li>
