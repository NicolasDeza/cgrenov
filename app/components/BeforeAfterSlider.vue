...
<template>
  ...
  <div class="pt-3">
    <NuxtLink
      to="/contact"
      class="group relative inline-flex items-center justify-center gap-3 rounded-lg bg-primary px-8 py-3 font-bold text-white  transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden"
    >
